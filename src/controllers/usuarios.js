...
export const putResumen = (req, res) => sql.addAnalisis(req.body.id, req.body.date, req.body.resumen, req.body.url)
  .then((result) => res.status(200).json(result))
  .catch((error) => res.status(500).json(error)
  )
// GET
...
export const getTareas = async (req, res) => await sql.getTareas(req.query.id)
  .then((result) => res.status(200).json(result))
  .catch((error) => res.status(500).json(error)
  )
export const getTodasTareas = async (req, res) => await sql.todoTareas(req.query.id)
  .then((result) => res.status(200).json(result))
  .catch((error) => res.status(500).json(error)
  )
...
export const getAtrasos = async (req, res) => await sql.getAtrasos(req.query.id)
  .then((result) => res.status(200).json(result))
  .catch((error) => res.status(500).json(error)
  )
...
export const putTarea = (req, res) => sql.putTarea(req.body.id, req.body.estado)
  .then((result) => res.status(200).json(result))
  .catch((error) => res.status(500).json(error)
  )
...
export const posTarea = (req, res) => sql.postTarea(req.body)
  .then((result) => res.status(200).json(result))
  .catch((error) => res.status(500).json(error)
  )
...
export const deleteTarea = (req, res) => sql.deleteTarea(req.query.id)
  .then((result) => res.status(200).json(result))
  .catch((error) => res.status(500).json(error)
  )
